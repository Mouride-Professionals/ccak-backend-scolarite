...
class Grade extends Model implements AuditableContract
{
    ...
    protected $fillable = ['course_enrollment_id', 'student_id', 'course_id', 'assessment_id', 'exam_schedule_id', 'type', 'score', 'max_score', 'weight', 'entered_by', 'status', 'entered_at', 'validated_at'];
